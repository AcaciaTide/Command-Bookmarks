...
public class EditBookmarkScreen extends Screen {
    ...
    public EditBookmarkScreen(BookmarkListScreen parent, Bookmark targetBookmark) {
        super(Text.translatable("gui.commandbookmark.edit.title"));
        this.parent = parent;
    ...
    protected void init() {
        ...
        this.labelField.setText(this.targetBookmark.getLabel());
        ...
        this.commandField.setText(this.targetBookmark.getCommand());
